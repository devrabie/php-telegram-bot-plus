 ...
 * @method bool getCanManageTags()       Optional. True, if the administrator can manage chat member tags; for channels only
 *
 ...
 * @method $this setCanManageTags(bool $can_manage_tags)              Optional. True, if the administrator can manage chat member tags; for channels only
 */
