 ...
 * @method static ServerResponse promoteChatMember(array $data)               Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Pass False for all boolean parameters to demote a user. Returns True on success. The parameter can_manage_direct_messages and can_manage_tags can be used to pass the rights.
 ...
 * @method static ServerResponse getChat(array $data)                         Use this method to get up to date information about the chat (current name of the user for oneonone conversations, current username of a user, group or channel, etc.). Returns a ChatFullInfo object on success.
 ...
 * @method static ServerResponse setChatMemberTag(array $data)                Use this method to set a custom title for an ordinary user in a supergroup. Returns True on success.
